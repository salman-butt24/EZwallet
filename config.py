...
class Config(object):
	...
	#SQLALCHEMY_DATABASE_URI = "mysql+pymysql://ezwallet:ezwallet@db-instance.c798x8idlrk0.us-east-1.rds.amazonaws.com/ezwalletdb" 

	SQLALCHEMY_TRACK_MODIFICATIONS = False

	#<<<<<<<<<<<<<< NEW CODE >>>>>>>>>>>>>>>>#
	SIMPLIFY_PUBLIC_KEY = os.environ.get('SIMPLIFY_PUBLIC_KEY') or "sbpb_Njc3ZDkyMmYtYTE0OS00MTRjLWE5YmUtZjQ3MTI5ZWUzNmE3"
	SIMPLIFY_PRIVATE_KEY = os.environ.get('SIMPLIFY_PUBLIC_KEY') or "3KzZq8dCCUhQMh1dTCU6jPrwdG0O4wwwizAP82LcfpN5YFFQL0ODSXAOkNtXTToq"
